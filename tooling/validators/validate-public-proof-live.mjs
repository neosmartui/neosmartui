...
for (const entry of proven) {
  ...
  for (const marker of ['NeoSmartUI Foundry', 'core.button', 'Pressure, not levitation']) if (!html.includes(marker)) throw new Error(`[public-proof-live] ${entry.id} live page missing ${marker}`);
