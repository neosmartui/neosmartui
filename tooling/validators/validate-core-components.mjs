...
if (!comboboxEntry || comboboxEntry.maturity !== 'implemented') fail('core.combobox must be implemented in Slice 17');
...
if (comboboxEntry.evidence.publicProof !== null) fail('implemented core.combobox must not claim public proof');
