...
if (!segmentedEntry || segmentedEntry.maturity !== 'implemented') fail('core.segmented-control must be implemented in this slice');
...
if (segmentedEntry.evidence.publicProof !== null) fail('implemented core.segmented-control must not claim public proof before deployment');
