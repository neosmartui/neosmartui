...
if (!paginationEntry || paginationEntry.maturity !== 'implemented') fail('core.pagination must be implemented in this slice');
...
if (paginationEntry.evidence.publicProof !== null) fail('implemented core.pagination must not claim public proof before deployment');
