...
if (!accordionEntry || accordionEntry.maturity !== 'implemented') fail('core.accordion must be implemented in Slice 18 implementation phase');
...
if (accordionEntry.evidence.publicProof !== null) fail('implemented core.accordion must not claim public proof before deployment verification');
