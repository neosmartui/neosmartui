...
if (!badgeEntry || badgeEntry.maturity !== 'implemented') fail('core.badge must be implemented in this slice');
...
if (badgeEntry.evidence.publicProof !== null) fail('implemented core.badge must not claim public proof');
