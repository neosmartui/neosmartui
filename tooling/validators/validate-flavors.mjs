...
console.log('[flavors] validated public-proof Hardline and Soft Light, contract-only Soft Dark, existing Rivet Flavor identity, and public-proof Mono Light resolution boundary');
