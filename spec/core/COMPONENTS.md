...
Its current public proof is refreshed onto the same exact merged-main Chromium artifact and native GitHub Pages deployment cohort as every public Core primitive. The current singleton cohort binds source `f4fdf3fbf3924b1598e1ee5be4dda22edcbf73e6`, merged-main Quality run `34677415919`, browser artifact `10292104339`, deployment tree `dd1bdf23838ffe5f79d6085b0d0544f5f03adff4`, and Pages run `34678037957`; live verification still requires the canonical automatic/manual Tabs markers.
...
Its current public proof shares the singleton cohort at source `f4fdf3fbf3924b1598e1ee5be4dda22edcbf73e6`, merged-main Quality run `34677415919`, browser artifact `10292104339`, deployment tree `dd1bdf23838ffe5f79d6085b0d0544f5f03adff4`, and native Pages run `34678037957`. Live verification requires the page to expose the canonical multiline textarea, non-pressable, and resize markers while structural validation preserves its own implementation blob binding.
...
Its public proof is bound to merged-main Quality run `34677415919`, browser artifact `10292104339`, deployment commit `bbd5696b4b0e24ab1fd4d5c8c0b6e462608667fa`, deployment tree `dd1bdf23838ffe5f79d6085b0d0544f5f03adff4`, and native Pages run `34678037957`. Live verification requires `https://neosmartui.github.io/deployment.json` to report source `f4fdf3fbf3924b1598e1ee5be4dda22edcbf73e6` and the page to expose the canonical native single-select and browser/OS picker-boundary markers. All sixteen public-proof components share this singleton cohort while retaining their own implementation blob bindings.
...
Its public proof is bound to the same singleton cohort as the other fifteen public Core primitives: merged source `f4fdf3fbf3924b1598e1ee5be4dda22edcbf73e6`, Quality run `34677415919`, browser artifact `10292104339`, deployment commit `bbd5696b4b0e24ab1fd4d5c8c0b6e462608667fa`, deployment tree `dd1bdf23838ffe5f79d6085b0d0544f5f03adff4`, and Pages run `34678037957`. Structural proof validation recomputes the Card CSS blob, and live verification requires the deployed Card markers without adding any whole-card interaction semantics.
...
Registry maturity is `public-proof`, with implementation evidence bound to `packages/adapters/web/components/alert.css` and canonical proof `evidence/public/core.alert.json`. Its singleton cohort binds source `f4fdf3fbf3924b1598e1ee5be4dda22edcbf73e6`, merged-main Quality run `34677415919`, browser artifact `10292104339`, deployment commit `bbd5696b4b0e24ab1fd4d5c8c0b6e462608667fa`, deployment tree `dd1bdf23838ffe5f79d6085b0d0544f5f03adff4`, and Pages run `34678037957`; live verification requires all five Alert tone markers plus the explicit no-implicit-live-region copy.
...
Registry maturity is `public-proof`. Canonical implementation evidence remains `packages/adapters/web/components/field.css` with canonical proof `evidence/public/core.field.json`. Its singleton cohort binds source `f4fdf3fbf3924b1598e1ee5be4dda22edcbf73e6`, merged-main Quality run `34677415919`, browser artifact `10292104339`, deployment commit `bbd5696b4b0e24ab1fd4d5c8c0b6e462608667fa`, deployment tree `dd1bdf23838ffe5f79d6085b0d0544f5f03adff4`, and Pages run `34678037957`; live verification requires the deployed Field label/help/invalid/disabled markers while structural validation recomputes the Field CSS blob.
...
Registry maturity is `public-proof`, with canonical implementation evidence `packages/adapters/web/components/pagination.css` and canonical proof `evidence/public/core.pagination.json`. Its singleton cohort binds merged source `f4fdf3fbf3924b1598e1ee5be4dda22edcbf73e6`, merged-main Quality run `34677415919`, browser artifact `10292104339`, deployment commit `bbd5696b4b0e24ab1fd4d5c8c0b6e462608667fa`, deployment tree `dd1bdf23838ffe5f79d6085b0d0544f5f03adff4`, and Pages run `34678037957`; structural proof validation recomputes the Pagination CSS blob and live verification requires the deployed native Pagination markers. All sixteen public-proof components share this singleton deployment/browser cohort while retaining their own implementation blob bindings.
...
Registry maturity is `public-proof`, with canonical implementation evidence `packages/adapters/web/components/segmented-control.mjs` and canonical proof `evidence/public/core.segmented-control.json`. Its singleton cohort binds merged source `f4fdf3fbf3924b1598e1ee5be4dda22edcbf73e6`, merged-main Quality run `34677415919`, browser artifact `10292104339`, deployment commit `bbd5696b4b0e24ab1fd4d5c8c0b6e462608667fa`, deployment tree `dd1bdf23838ffe5f79d6085b0d0544f5f03adff4`, and Pages run `34678037957`; structural proof validation recomputes both Segmented Control implementation blobs and live verification requires the deployed Segmented Control marker contract. All sixteen public-proof components share this singleton deployment/browser cohort while retaining their own implementation blob bindings.
...
Registry maturity is `public-proof`, with canonical implementation evidence `packages/adapters/web/components/tooltip.mjs` and canonical proof `evidence/public/core.tooltip.json`. Its singleton cohort binds merged source `f4fdf3fbf3924b1598e1ee5be4dda22edcbf73e6`, merged-main Quality run `34677415919`, browser artifact `10292104339`, deployment commit `bbd5696b4b0e24ab1fd4d5c8c0b6e462608667fa`, deployment tree `dd1bdf23838ffe5f79d6085b0d0544f5f03adff4`, and Pages run `34678037957`; structural proof validation recomputes both Tooltip implementation blobs and live verification requires the deployed Tooltip marker contract. All sixteen public-proof components share this singleton deployment/browser cohort while retaining their own implementation blob bindings.

## Slice 17: `core.combobox`

`core.combobox` is implemented as NeoSmartUI's first editable suggestion-list single-selection composite. It remains deliberately distinct from `core.select`: Select preserves a browser-owned picker and no portable open state, while Combobox owns editable query text, an explicitly related suggestion popup, transient active-option navigation, and one committed selected value.
...
Registry maturity is `implemented`, with canonical implementation evidence `packages/adapters/web/components/combobox.mjs` and paired CSS at `packages/adapters/web/components/combobox.css`. Public-proof evidence remains `null`: this slice does not claim deployment proof. The next lifecycle stage requires exact-head implementation CI, a green merged-main run, deployment of that exact merged-main artifact, native Pages verification, and only then singleton public-proof promotion.
