...
Its current public proof is refreshed onto the same exact merged-main Chromium artifact and native GitHub Pages deployment cohort as every public Core primitive. The current singleton cohort binds source `1cc08cf241dfbd977d3afd999160ff015c8e060f`, merged-main Quality run `34655777104`, browser artifact `10285945636`, deployment tree `d454b4fcd9ce41ee305eef2cad839e98189c4515`, and Pages run `34656190416`; live verification still requires the canonical automatic/manual Tabs markers.
...
Its current public proof shares the singleton cohort at source `1cc08cf241dfbd977d3afd999160ff015c8e060f`, merged-main Quality run `34655777104`, browser artifact `10285945636`, deployment tree `d454b4fcd9ce41ee305eef2cad839e98189c4515`, and native Pages run `34656190416`. Live verification requires the page to expose the canonical multiline textarea, non-pressable, and resize markers while structural validation preserves its own implementation blob binding.
...
Its public proof is bound to merged-main Quality run `34655777104`, browser artifact `10285945636`, deployment commit `d9a0ca1860e50ab39799d641e3b642751268fdd1`, deployment tree `d454b4fcd9ce41ee305eef2cad839e98189c4515`, and native Pages run `34656190416`. Live verification requires `https://neosmartui.github.io/deployment.json` to report source `1cc08cf241dfbd977d3afd999160ff015c8e060f` and the page to expose the canonical native single-select and browser/OS picker-boundary markers. All thirteen public-proof components share this singleton cohort while retaining their own implementation blob bindings.
...
Its public proof is bound to the same singleton cohort as the other twelve public Core primitives: merged source `1cc08cf241dfbd977d3afd999160ff015c8e060f`, Quality run `34655777104`, browser artifact `10285945636`, deployment commit `d9a0ca1860e50ab39799d641e3b642751268fdd1`, deployment tree `d454b4fcd9ce41ee305eef2cad839e98189c4515`, and Pages run `34656190416`. Structural proof validation recomputes the Card CSS blob, and live verification requires the deployed Card markers without adding any whole-card interaction semantics.
...
Registry maturity is `public-proof`, with implementation evidence bound to `packages/adapters/web/components/alert.css` and canonical proof `evidence/public/core.alert.json`. Its singleton cohort binds source `1cc08cf241dfbd977d3afd999160ff015c8e060f`, merged-main Quality run `34655777104`, browser artifact `10285945636`, deployment commit `d9a0ca1860e50ab39799d641e3b642751268fdd1`, deployment tree `d454b4fcd9ce41ee305eef2cad839e98189c4515`, and Pages run `34656190416`; live verification requires all five Alert tone markers plus the explicit no-implicit-live-region copy.
...
Registry maturity is `public-proof`. Canonical implementation evidence remains `packages/adapters/web/components/field.css` with canonical proof `evidence/public/core.field.json`. Its singleton cohort binds source `1cc08cf241dfbd977d3afd999160ff015c8e060f`, merged-main Quality run `34655777104`, browser artifact `10285945636`, deployment commit `d9a0ca1860e50ab39799d641e3b642751268fdd1`, deployment tree `d454b4fcd9ce41ee305eef2cad839e98189c4515`, and Pages run `34656190416`; live verification requires the deployed Field label/help/invalid/disabled markers while structural validation recomputes the Field CSS blob.
...
Registry maturity is `public-proof`, with canonical implementation evidence `packages/adapters/web/components/breadcrumb.css` and canonical proof `evidence/public/core.breadcrumb.json`. Its singleton cohort binds source `1cc08cf241dfbd977d3afd999160ff015c8e060f`, merged-main Quality run `34655777104`, browser artifact `10285945636`, deployment commit `d9a0ca1860e50ab39799d641e3b642751268fdd1`, deployment tree `d454b4fcd9ce41ee305eef2cad839e98189c4515`, and Pages run `34656190416`; structural proof validation recomputes the Breadcrumb CSS blob and live verification requires the native-link hierarchy markers.

## Slice 14: `core.pagination`

`core.pagination` starts contract-only as generic navigation across discrete pages in one ordered collection. It introduces a new semantic class rather than another panel selector: real destinations are real links, exactly one page is identified as current with `aria-current="page"`, and routing, URL serialization, fetching, total-count discovery, page-size policy, virtual scrolling, and infinite-scroll behavior remain outside Core Pagination.

Pagination is deliberately not Tabs. It does not own a tablist/tabpanel relationship or Arrow-key roving focus; reachable destinations participate in ordinary document navigation and retain native anchor behavior. The current page is non-interactive by default instead of a redundant self-link, while unavailable previous/next boundaries must not remain apparently active links whose only disabling mechanism is `aria-disabled="true"`.

Unlike Breadcrumb's inline ancestor links, reachable Pagination items are compact standalone navigation controls. They therefore follow the permanent pressure-not-levitation law: rest has structural depth, hover/contact moves toward the surface, press reaches or approaches active compression, and release restores depth. Current, unavailable, and passive ellipsis items do not manufacture tactile activation. Every reachable standalone target must meet or exceed `size.control.minimum`, preserving NeoSmartUI's existing 44px target even though pinned Soft used a smaller 2.45rem legacy item.

The contract introduces no new token contracts. It combines already-established navigation rhythm/typography (`space.navigation.gap`, `font.size.navigation`) with existing control geometry, 44px target, depth/press motion, focus-ring, interactive-surface, primary-action, disabled-opacity, and emphasis roles. Token-contract count therefore remains 63. At contract-only maturity Pagination does not enter Rivet Light scope, so the exact implemented/public dependency union remains 55; later implementation should need zero new token roles because all declared dependencies are already resolved.
...
Registry maturity is `contract-only`. Canonical implementation evidence and public proof remain null. This slice adds no Web adapter, Theme value/scope change, Foundry example, browser test, workflow change, or public-proof mutation; all 13 existing public-proof records remain untouched.
