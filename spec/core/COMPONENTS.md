...
Its current public proof is refreshed onto the same exact merged-main Chromium artifact and native GitHub Pages deployment cohort as every public Core primitive. The current singleton cohort binds source `8508ffd2910ecc32cc6e45e10ff1197b0187e33c`, merged-main Quality run `34668050460`, browser artifact `10290170049`, deployment tree `d581827d86ebfbc6f1c21949c0b0a4f40430cd37`, and Pages run `34668426196`; live verification still requires the canonical automatic/manual Tabs markers.
...
Its current public proof shares the singleton cohort at source `8508ffd2910ecc32cc6e45e10ff1197b0187e33c`, merged-main Quality run `34668050460`, browser artifact `10290170049`, deployment tree `d581827d86ebfbc6f1c21949c0b0a4f40430cd37`, and native Pages run `34668426196`. Live verification requires the page to expose the canonical multiline textarea, non-pressable, and resize markers while structural validation preserves its own implementation blob binding.
...
Its public proof is bound to merged-main Quality run `34668050460`, browser artifact `10290170049`, deployment commit `9a498c52628306dd46565ca478b2f9059088c91f`, deployment tree `d581827d86ebfbc6f1c21949c0b0a4f40430cd37`, and native Pages run `34668426196`. Live verification requires `https://neosmartui.github.io/deployment.json` to report source `8508ffd2910ecc32cc6e45e10ff1197b0187e33c` and the page to expose the canonical native single-select and browser/OS picker-boundary markers. All fifteen public-proof components share this singleton cohort while retaining their own implementation blob bindings.
...
Its public proof is bound to the same singleton cohort as the other fourteen public Core primitives: merged source `8508ffd2910ecc32cc6e45e10ff1197b0187e33c`, Quality run `34668050460`, browser artifact `10290170049`, deployment commit `9a498c52628306dd46565ca478b2f9059088c91f`, deployment tree `d581827d86ebfbc6f1c21949c0b0a4f40430cd37`, and Pages run `34668426196`. Structural proof validation recomputes the Card CSS blob, and live verification requires the deployed Card markers without adding any whole-card interaction semantics.
...
Registry maturity is `public-proof`, with implementation evidence bound to `packages/adapters/web/components/alert.css` and canonical proof `evidence/public/core.alert.json`. Its singleton cohort binds source `8508ffd2910ecc32cc6e45e10ff1197b0187e33c`, merged-main Quality run `34668050460`, browser artifact `10290170049`, deployment commit `9a498c52628306dd46565ca478b2f9059088c91f`, deployment tree `d581827d86ebfbc6f1c21949c0b0a4f40430cd37`, and Pages run `34668426196`; live verification requires all five Alert tone markers plus the explicit no-implicit-live-region copy.
...
Registry maturity is `public-proof`. Canonical implementation evidence remains `packages/adapters/web/components/field.css` with canonical proof `evidence/public/core.field.json`. Its singleton cohort binds source `8508ffd2910ecc32cc6e45e10ff1197b0187e33c`, merged-main Quality run `34668050460`, browser artifact `10290170049`, deployment commit `9a498c52628306dd46565ca478b2f9059088c91f`, deployment tree `d581827d86ebfbc6f1c21949c0b0a4f40430cd37`, and Pages run `34668426196`; live verification requires the deployed Field label/help/invalid/disabled markers while structural validation recomputes the Field CSS blob.
...
Registry maturity is `public-proof`, with canonical implementation evidence `packages/adapters/web/components/breadcrumb.css` and canonical proof `evidence/public/core.breadcrumb.json`. Its singleton cohort binds source `8508ffd2910ecc32cc6e45e10ff1197b0187e33c`, merged-main Quality run `34668050460`, browser artifact `10290170049`, deployment commit `9a498c52628306dd46565ca478b2f9059088c91f`, deployment tree `d581827d86ebfbc6f1c21949c0b0a4f40430cd37`, and Pages run `34668426196`; structural proof validation recomputes the Breadcrumb CSS blob and live verification requires the native-link hierarchy markers.
...
Registry maturity is `public-proof`, with canonical implementation evidence `packages/adapters/web/components/pagination.css` and canonical proof `evidence/public/core.pagination.json`. Its singleton cohort binds merged source `8508ffd2910ecc32cc6e45e10ff1197b0187e33c`, merged-main Quality run `34668050460`, browser artifact `10290170049`, deployment commit `9a498c52628306dd46565ca478b2f9059088c91f`, deployment tree `d581827d86ebfbc6f1c21949c0b0a4f40430cd37`, and Pages run `34668426196`; structural proof validation recomputes the Pagination CSS blob and live verification requires the deployed native Pagination markers. All fifteen public-proof components share this singleton deployment/browser cohort while retaining their own implementation blob bindings.
...
Registry maturity is `public-proof`, with canonical implementation evidence `packages/adapters/web/components/segmented-control.mjs` and canonical proof `evidence/public/core.segmented-control.json`. Its singleton cohort binds merged source `8508ffd2910ecc32cc6e45e10ff1197b0187e33c`, merged-main Quality run `34668050460`, browser artifact `10290170049`, deployment commit `9a498c52628306dd46565ca478b2f9059088c91f`, deployment tree `d581827d86ebfbc6f1c21949c0b0a4f40430cd37`, and Pages run `34668426196`; structural proof validation recomputes both Segmented Control implementation blobs and live verification requires the deployed Segmented Control marker contract. All fifteen public-proof components share this singleton deployment/browser cohort while retaining their own implementation blob bindings.

## Slice 16: `core.tooltip`

`core.tooltip` is now implemented as a concise supplemental-description primitive with a canonical Web CSS/MJS pair. The described target keeps its own semantics and focusability while the separate `role="tooltip"` surface is linked through `aria-describedby`; Tooltip remains supplemental, non-interactive, and outside the Tab order.
...
The surface reuses existing panel/content/border roles, annotation spacing/border/radius, resting depth, and body typography. Rivet Light scope now includes `core.tooltip`, but every dependency was already present in the implemented/public union: semantic token contracts remain 63, the exact dependency union remains 55, and every concrete Theme value remains unchanged.
...
Registry maturity is `implemented`, with canonical implementation evidence `packages/adapters/web/components/tooltip.mjs` and public-proof evidence still `null`. Public proof must wait for an exact merged-main 85/85 artifact, exact artifact deployment, native Pages verification, and the normal singleton cohort refresh.
